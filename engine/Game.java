...
public class Game {
	...
	public void endTurn() {
		//System.out.println("beg of end turn" +turnOrder.peekMin().toString());
		turnOrder.remove();
		...
		//System.out.println("end  of end turn" + turnOrder.peekMin().toString());
	...
	public boolean isCurrChampDisarmed()
		{
	...
	public boolean isCurrChampSilenced()
	{
		for(int i=0;i<getCurrentChampion().getAppliedEffects().size();i++)
